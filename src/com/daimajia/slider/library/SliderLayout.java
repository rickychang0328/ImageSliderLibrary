...
import com.daimajia.slider.library.listener.OnSwipeTouchListener;
...
public class SliderLayout extends RelativeLayout{
    ...
    public void setInfinite(boolean isInfinite){
    	InfinitePagerAdapter adapter = getWrapperAdapter();
    	if(adapter!=null)
    		adapter.setInfinite(isInfinite);
    }
    public boolean isInfinite(){
    	InfinitePagerAdapter adapter = getWrapperAdapter();
    	if(adapter!=null)
    		return adapter.isInfinite();
    	else
    		return true;
    }
	/**
    ...
    public void setOnSliderPageChangeListener(OnPageChangeListener listener){
    	if(listener != null){
    ...
    public int getCurrentPosition(){
        ...
        int mPosition = 0;
        try{
        	mPosition = mViewPager.getCurrentItem() % getRealAdapter().getCount();
        }catch(Exception e){
    ...
    private void DEBUG(String message){
    	if(DEBUG)
    		Log.e(SliderLayout.class.getSimpleName(),message);
    }
}
