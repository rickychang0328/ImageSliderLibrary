...
public class SliderAdapter extends PagerAdapter implements BaseSliderView.ImageLoadListener{
    ...
    public ArrayList<BaseSliderView> getSliderViews(){
    ...
    public <T extends BaseSliderView> void addSlider(T slider){
        ...
        debug("add slider and notifyDataSetChanged");
//        notifyDataSetChanged();
    }
    public <T extends BaseSliderView> void addSlider(T slider,int position){
        slider.setOnImageLoadListener(this);
...
//        notifyDataSetChanged();
    ...
    @Override
    public int getCount() {
    	debug("getCount:"+mImageContents.size());
    ...
    private void debug(String message){
    	if(DEBUG)
    		Log.e(SliderAdapter.class.getSimpleName(),message);
    }
}
